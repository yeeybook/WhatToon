...
public class RatingActivity4 extends AppCompatActivity {
    ...
    String [] webtoonList = {"513", "408", "5", "369", "257", "55"};
    String [] titleList = {"세로토닌", "이태원 클라쓰", "파이게임", "치즈인더트랩", "유미의 세포들", "바른연애 길잡이"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), RatingActivity5.class);
